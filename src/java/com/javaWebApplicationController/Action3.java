...
@WebServlet(name = "Action3", urlPatterns = {"/Action3"})
public class Action3 extends HttpServlet {
    private static final Logger logger = Logger.getLogger(Action3.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>ModeleIntretinute</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try (Connection con = db.makeConnection();
                 PreparedStatement ps = con.prepareStatement("Select M.Nume + ' ' + M.Prenume as [Nume Model] from Modele M "
                         + "JOIN Impresari I on M.IDImpresar=I.IDImpresar "
